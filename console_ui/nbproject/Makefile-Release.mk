...
${OBJECTDIR}/source/console_ui.o: source/console_ui.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/console_ui.o source/console_ui.cpp

${OBJECTDIR}/source/main_menu.o: source/main_menu.cpp 
	${MKDIR} -p ${OBJECTDIR}/source
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/main_menu.o source/main_menu.cpp
...
${TESTDIR}/tests/main_menu_test.o: tests/main_menu_test.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -I. -I. `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/main_menu_test.o tests/main_menu_test.cpp


${TESTDIR}/tests/runner.o: tests/runner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -I. -I. `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/runner.o tests/runner.cpp
...
${OBJECTDIR}/source/console_ui_nomain.o: ${OBJECTDIR}/source/console_ui.o source/console_ui.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/console_ui_nomain.o source/console_ui.cpp;\
	else  \
...
${OBJECTDIR}/source/main_menu_nomain.o: ${OBJECTDIR}/source/main_menu.o source/main_menu.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/main_menu_nomain.o source/main_menu.cpp;\
	else  \
